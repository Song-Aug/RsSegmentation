"""
TransCCV3 消融实验: 仅 CNN 编码器

验证 Transformer 编码器的有效性（关闭 Transformer，仅使用 CNN）
"""
...
config = {
    ...
    # ========== 模型配置 ==========
    "model_name": "TransCCV3_Ablation_CNN_Only",
    "num_classes": 2,
    "patch_size": 16,
    "embed_dim": 768,
    "depth": 9,
    ...
    # ========== 编码器开关（消融实验）==========
    "use_transformer": False,  # 关闭 Transformer
    "use_cnn": True,  # 仅使用 CNN
