"""
TransCCV3 消融实验: 仅 Transformer 编码器

验证 CNN 编码器的有效性（关闭 CNN，仅使用 Transformer）
"""
...
config = {
    ...
    # ========== 模型配置 ==========
    "model_name": "TransCCV3_Ablation_Transformer_Only",
    "num_classes": 2,
    "patch_size": 16,
    "embed_dim": 768,
    "depth": 9,
    ...
    # ========== 编码器开关（消融实验）==========
    "use_transformer": True,  # 仅使用 Transformer
    "use_cnn": False,  # 关闭 CNN
